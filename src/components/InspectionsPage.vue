...
const inspections = useCollection(query(collection(db, 'inspections'), orderBy('date', 'desc')));
...
<template>
  <h1 class="border-2 mb-16 p-4 text-2xl shadow-md">Inspector Dashboard</h1>
  <div class="col-span-2 lg:col-span-1 border-2 w-full h-96 max-w-5xl mx-auto">
    <h2 class="text-xl px-4 py-2">Inspections</h2>
